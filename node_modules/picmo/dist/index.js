...
}, A = (o, e, t, i) => (U(o, e, "write to private field"), i ? i.call(o, t) : e.set(o, t), t);
...
async function re(o, e = {}) {
  const {
    ...
    cdnUrl: s,
    ...r
  } = e, a = Te(o, i, s), n = t ? localStorage : sessionStorage, l = `emojibase/${i}/${o}`, m = n.getItem(l);
  if (m)
...
async function de(o, e, t) {
  var i;
  return re(`${o}/shortcodes/${(i = Ve[e]) !== null && i !== void 0 ? i : e}.json`, t);
}
function k(o, e) {
  if (e.length === 0)
    return o;
...
function qe(o, e) {
  return Ke.some((t) => t(o, e) === null) ? null : o;
}
function D(o, e) {
  return o.filter((t) => qe(t, e) !== null);
}
const q = {};
function Ee(o) {
  return q[o] || (q[o] = new Ge(o)), q[o];
}
Ee.deleteDatabase = (o) => {
};
class Ge extends xe {
  ...
  getEmojis(e, t) {
    ...
    return Promise.resolve(D(i, t));
  }
  searchEmojis(e, t, i, s) {
    const r = this.emojis.filter((l) => B(l, e, s) && l.version <= i).map(x), a = t.filter((l) => B(l, e, s)), n = [
      ...D(r, i),
      ...a
    ];
...
He() || (console.warn("[picmo] sessionStorage not available, falling back to simple in-memory storage"), Object.defineProperty(window, "sessionStorage", {
  value: ke()
}));
function We(o, e) {
...
function Je(o) {
  const { emojisUrl: e, messagesUrl: t } = We("latest", o);
  try {
    return Promise.all([
      pe(e),
      pe(t)
...
async function Se(o, e, t) {
  ...
  try {
    ...
    console.warn("[picmo] IndexedDB not available, falling back to InMemoryStoreFactory"), i = Ee(o);
  }
  return i;
}
async function Xe(o, e, t) {
  const i = await Se(o, e, t), [s, r] = await Je(o);
...
async function Ze(o, e, t, i, s) {
  const r = await Se(o, e, s), a = await Ne(i);
  return (!await r.isPopulated() || await Qe(r, a)) && await r.populate({ groups: t.groups, emojis: i, hash: a }), r;
}
async function ne(o, e, t, i, s) {
  return t && i ? Ze(o, e, t, i, s) : Xe(o, e, s);
}
function Io(o, e) {
  o.deleteDatabase(e);
}
...
const ot = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M256 512C114.6 512 0 397.4 0 256C0 114.6 114.6 0 256 0C397.4 0 512 114.6 512 256C512 397.4 397.4 512 256 512zM232 256C232 264 236 271.5 242.7 275.1L338.7 339.1C349.7 347.3 364.6 344.3 371.1 333.3C379.3 322.3 376.3 307.4 365.3 300L280 243.2V120C280 106.7 269.3 96 255.1 96C242.7 96 231.1 106.7 231.1 120L232 256z"/></svg>', it = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M64 496C64 504.8 56.75 512 48 512h-32C7.25 512 0 504.8 0 496V32c0-17.75 14.25-32 32-32s32 14.25 32 32V496zM476.3 0c-6.365 0-13.01 1.35-19.34 4.233c-45.69 20.86-79.56 27.94-107.8 27.94c-59.96 0-94.81-31.86-163.9-31.87C160.9 .3055 131.6 4.867 96 15.75v350.5c32-9.984 59.87-14.1 84.85-14.1c73.63 0 124.9 31.78 198.6 31.78c31.91 0 68.02-5.971 111.1-23.09C504.1 355.9 512 344.4 512 332.1V30.73C512 11.1 495.3 0 476.3 0z"/></svg>', st = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M0 256C0 114.6 114.6 0 256 0C397.4 0 512 114.6 512 256C512 397.4 397.4 512 256 512C114.6 512 0 397.4 0 256z
7 506.5 396L378.5 508C372.9 512.1 364.6 513.3 358.6 508.9C352.6 504.6 350.3 496.6 353.3 489.7L391.7 399.1H336C329.3 399.1 323.4 395.9 321 389.6C318.7 383.4 320.4 376.3 325.5 371.1L453.5 259.1C459.1 255 467.4 254.7 473.4 259.1C479.4 263.4 481.6 271.4 478.7 278.3L440.3 367.1zM116.7 219.1L19.85 119.2C-8.112 90.26-6.614 42.31 24.85 15.34C51.82-8.137 93.26-3.642 118.2 21.83L128.2 32.32L137.7 21.83C162.7-3.642 203.6-8.137 231.6 15.34C262.6 42.31 264.1 90.26 236.1 119.2L139.7 219.1C133.2 225.6 122.7 225.6 116.7 219.1H116.7z"/></svg>', ut = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M413.8 447.1L256 448l0 31.99C256 497.7 241.8 512 224.1 512c-17.67 0-32.1-14.32-32.1-31.99l0-31.99l-158.9-.0099c-28.5 0-43.69-34.49-24.69-56.4l68.98-79.59H62.22c-25.41 0-39.15-29.8-22.67-49.13l60.41-70.85H89.21c-21.28 0-32.87-22.5-19.28-37.31l134.8-146.5c10.4-11.3 28.22-11.3 38.62-.0033l134.9 146.5c13.62 14.81 2.001 37.31-19.28 37.31h-10.77l60.35 70.86c16.46 19.34 2.716 49.12-22.68 49.12h-15.2l68.98 79.59C458.7 413.7 443.1 447.1 413.8 447.1z"/></svg>', gt = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"><!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M224 256c70.7 0 128-57.31 128-128S294.7 0 224 0C153.3 0 96 57.31 96 128S153.3 256 224 256zM274.7 304H173.3c-95.73 0-173.3 77.6-173.3 173.3C0 496.5 15.52 512 34.66 512H413.3C432.5 512 448 496.5 448 477.3C448 381.6 370.4 304 274.7 304zM479.1 320h-73.85C451.2 357.7 480 414.1 480 477.3C480 490.1 476.2 501.9 470 512h138C625.7 512 640 497.6 640 479.1C640 391.6 568.4 320 479.1 320zM432 256C493.9 256 544 205.9 544 144S493.9 32 432 32c-25.11 0-48.04 8.555-66.72 22.51C376.8 76.63 384 101.4 384 128c0 35.52-11.93 68.14-31.59 94.71C372.7 243.2 400.8 256 432 256z"/></svg>', yt = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
  <defs>
...
</svg>`, ft = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512"><!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M310.6 361.4c12.5 12.5 12.5 32.75 0 45.25C304.4 412.9 296.2 416 288 416s-16.38-3.125-22.62-9.375L160 301.3L54.63 406.6C48.38 412.9 40.19 416 32 416S15.63 412.9 9.375 406.6c-12.5-12.5-12.5-32.75 0-45.25l105.4-105.4L9.375 150.6c-12.5-12.5-12.5-32.75 0-45.25s32.75-12.5 45.25 0L160 210.8l105.4-105.4c12.5-12.5 32.75-12.5 45.25 0s12.5 32.75 0 45.25l-105.4 105.4L310.6 361.4z"/></svg>';
function vt(o, e) {
  const t = Q(e);
...
class p {
  constructor(e, t = {}) {
    ...
    f(this, b, void 0);
    f(this, E, void 0);
    A(this, b, e), A(this, E, t.mode || wt.mode);
  }
  renderSync(e = {}) {
    const t = Q(y(this, b).call(this, e));
    return g(this, z, ee).call(this, t, e), g(this, P, Z).call(this, t), g(this, S, X).call(this, t, e), t;
  }
  async renderAsync(e = {}) {
    const t = Q(y(this, b).call(this, e));
    return g(this, z, ee).call(this, t, e), g(this, P, Z).call(this, t), await g(this, S, X).call(this, t, e), t;
  }
  render(e) {
...
class _t extends c {
  constructor({ classNames: e } = {}) {
    super({ template: Ct, classes: bt }), this.classNames = e;
  }
  load(e) {
...
const jt = u("customEmoji");
class kt {
  renderElement(e) {
    return { content: e };
  }
  renderImage(e = "", t) {
    const i = new _t({ classNames: e });
  ...
  renderCustom(e, t, i = "") {
    const s = [jt.customEmoji, i].join(" ").trim(), { content: r, resolver: a } = this.renderImage(s, () => e.url), n = r instanceof Element ? r : r.el;
    return a && a(), n;
  }
}
const xt = new p(({ emoji: o }) => `<span>${o}</span>`);
class Et extends kt {
  render(e) {
...
ze.deleteDatabase = (o) => new Promise((e, t) => {
  ...
  async searchEmojis(e, t, i, s) {
    ...
    return new Promise((a, n) => {
      ...
      d.addEventListener("success", (h) => {
        var he;
        const N = (he = h.target) == null ? void 0 : he.result;
        if (!N)
          return a([
            ...D(r, i),
            ...t.filter((Ie) => B(Ie, e))
        ...
        const H = N.value;
        B(H, e, s) && H.version <= i && r.push(x(H)), N.continue();
...
class Le extends $e {
  ...
  addOrUpdateRecent(e, t) {
    ...
    try {
      this.storage.setItem(G, JSON.stringify(i));
    } catch {
...
Ue() || (console.warn("[picmo] localStorage not available, falling back to simple in-memory storage"), Object.defineProperty(window, "localStorage", {
  value: ke()
}));
function Lt(o = {}) {
  return {
...
class ce {
  ...
  on(e, t, i) {
    g(this, $, oe).call(this, e, t, i);
  }
  once(e, t, i) {
    g(this, $, oe).call(this, e, t, i, !0);
  }
  off(e, t) {
...
}, $ = new WeakSet(), oe = function(e, t, i, s = !1) {
...
const Rt = new p(({ classes: o, emoji: e }) => `
  <button
    type="button"
    class="${o.emojiButton}"
    title="${e.label}"
...
class Fe extends c {
  constructor({ emoji: e, lazyLoader: t, category: i }) {
    super({ template: Rt, classes: Tt }), this.emoji = e, this.lazyLoader = t, this.category = i;
  }
  initialize() {
    this.uiEvents = [
...
class F extends c {
  constructor({ emojis: e, showVariants: t, preview: i = !0, lazyLoader: s, category: r, fullHeight: a = !1 }) {
    super({ template: Mt, classes: Bt }), this.fullHeight = !1, this.showVariants = t, this.lazyLoader = s, this.preview = i, this.emojis = e, this.category = r, this.fullHeight = a, this.setFocus = this.setFocus.bind(this), this.triggerNextCategory = this.triggerNextCategory.bind(this), this.triggerPreviousCategory = this.triggerPreviousCategory.bind(this);
  }
  initialize() {
...
const Dt = new p(({ classes: o, category: e, pickerId: t, icon: i, i18n: s }) => `
...
class Ot extends le {
  constructor({ category: e, showVariants: t, lazyLoader: i, emojiVersion: s }) {
    super({ category: e, showVariants: t, lazyLoader: i, template: Dt }), this.showVariants = t, this.lazyLoader = i, this.emojiVersion = s;
  }
  initialize() {
...
class Nt extends F {
  ...
  async addOrUpdate(e) {
    ...
    const i = this.viewFactory.create(Fe, { emoji: e });
...
const Ht = new p(({ emojiCount: o, classes: e, category: t, pickerId: i, icon: s, i18n: r }) => `
...
class Ut extends le {
  constructor({ category: e, lazyLoader: t, provider: i }) {
    super({ category: e, showVariants: !1, lazyLoader: t, template: Ht }), this.provider = i;
  }
  initialize() {
    this.uiElements = {
      ...this.baseUIElements,
  ...
  async render() {
    ...
    return this.emojiContainer = this.viewFactory.create(Nt, {
      emojis: e,
      showVariants: !1,
      lazyLoader: this.lazyLoader,
      category: this.category.key
...
const Kt = new p(({ classes: o, category: e, pickerId: t, icon: i, i18n: s }) => `
  <section class="${o.emojiCategory}" role="tabpanel" aria-labelledby="${t}-category-${e.key}">
    <h3 data-category="${e.key}" class="${o.categoryName}">
      <i data-icon="${i}"></i>
      ${s.get(`categories.${e.key}`, e.message || e.key)}
...
class qt extends le {
  constructor({ category: e, lazyLoader: t }) {
    super({ template: Kt, showVariants: !1, lazyLoader: t, category: e });
  }
  initialize() {
    this.uiElements = { ...this.baseUIElements }, super.initialize();
  }
...
const ge = u("emojiArea"), Gt = new p(({ classes: o }) => `
...
class Qt extends c {
  constructor({ categoryTabs: e, categories: t, emojiVersion: i }) {
    super({ template: Gt, classes: ge }), this.selectedCategory = 0, this.scrollListenerState = "active", this.lazyLoader = new Ae(), this.categoryTabs = e, this.categories = t, this.emojiVersion = i, this.handleScroll = De(this.handleScroll.bind(this), 100);
  }
  initialize() {
    this.appEvents = {
  ...
  async selectCategory(e, t = {}) {
    ...
    this.emojiCategories[a].setActive(!0, Yt(i), i !== "button" && s), r && (this.el.scrollTop = n), this.scrollListenerState = "resume";
  }
...
const Xt = new p(({ classList: o, classes: e, icon: t, message: i }) => `
...
class se extends c {
  constructor({ message: e, icon: t = "warning", template: i = Xt, className: s }) {
...
const Zt = new p(({ classList: o, classes: e, icon: t, i18n: i, message: s }) => `
  <div class="${o}" role="alert">
...
class to extends se {
  constructor({ message: e }) {
    super({ message: e, template: Zt, className: eo.dataError });
  }
  initialize() {
...
class so extends c {
  ...
  showPreview(e, t) {
    if (w(this.ui.emoji, t), this.ui.name.textContent = e.label, e.tags) {
      ...
      const i = e.tags.map((s) => oo.renderSync({ tag: s, classes: _ }));
      w(this.ui.tagList, ...i);
    }
  }
  hidePreview() {
...
class no extends c {
  constructor({ categories: e, emojiVersion: t }) {
    super({ template: ao, classes: j }), this.categories = e.filter((i) => i.key !== "recents"), this.emojiVersion = t, this.search = Oe(this.search.bind(this), 100);
  }
  initialize() {
    this.uiElements = {
  ...
  async render() {
    return await super.render(), this.searchIcon = Pe("search"), this.notFoundMessage = this.viewFactory.create(se, {
      message: this.i18n.get("search.notFound"),
      className: j.notFound,
      icon: "sad"
    }), this.notFoundMessage.renderSync(), this.errorMessage = this.viewFactory.create(se, { message: this.i18n.get("search.error") }), this.errorMessage.renderSync(), this.clearSearchButton = ro.render({
      classes: j,
      i18n: this.i18n
...
class lo extends c {
  constructor({ emoji: e, parent: t }) {
    super({ template: co, classes: fe, parent: t }), this.focusedEmojiIndex = 0, this.focusTrap = new et(), this.animateShow = () => Promise.all([
...
const ho = new p(({ classes: o, i18n: e, category: t, pickerId: i, icon: s }) => `
...
class mo extends c {
  ...
  setActive(e, t = {}) {
    ...
    this.el.classList.toggle(J.categoryTabActive, e), i && (this.ui.button.tabIndex = e ? 0 : -1, this.ui.button.ariaSelected = e.toString()), e && s && (this.ui.button.focus(), r && this.events.emit("category:select", this.category.key, { scroll: "animate", focus: "button", performFocus: !1 })), this.isActive = e;
  }
  selectCategory() {
    this.isActive || this.events.emit("category:select", this.category.key, { scroll: "animate", focus: "button", performFocus: !0 });
  }
}
const po = new p(({ classes: o }) => `
  <div class="${o.categoryButtonsContainer}">
    <ul role="tablist" class="${o.categoryButtons}">
      <div data-placeholder="tabs"></div>
    </ul>
  </div>
`), uo = u("categoryButtons", "categoryButtonsContainer");
class go extends c {
  constructor({ categories: e }) {
    super({ template: po, classes: uo }), this.activeCategoryIndex = 0, this.categories = e;
  }
  initialize() {
    this.keyBindings = {
  ...
  renderSync() {
    return this.tabViews = this.categories.map((e) => this.viewFactory.create(mo, { category: e, icon: O[e.key] })), super.renderSync({
...
const _o = new p((o) => o.isLoaded ? bo(o) : Co(o)), R = u(
  "picker",
  "skeleton",
  "placeholder",
  "searchSkeleton",
...
class jo extends c {
  constructor() {
    super({ template: _o, classes: R }), this.pickerReady = !1, this.externalEvents = new It(), this.updaters = {
      styleProperty: (e) => (t) => this.el.style.setProperty(T[e], t.toString()),
      theme: (e) => {
  ...
  initialize() {
    this.uiElements = {
      pickerContent: c.byClass(R.content),
      header: c.byClass(R.header)
    }, this.uiEvents = [
      c.uiEvent("keydown", this.handleKeyDown)
    ], this.appEvents = {
      error: this.onError,
  ...
  buildChildViews() {
    return this.options.showPreview && (this.preview = this.viewFactory.create(so)), this.options.showSearch && (this.search = this.viewFactory.create(no, {
  ...
  setStyleProperties() {
    this.options.showSearch || this.el.style.setProperty("--search-height-full", "0px"), this.options.showCategoryTabs || (this.el.style.setProperty("--category-tabs-height", "0px"), this.el.style.setProperty("--category-tabs-offset", "0px")), this.options.showPreview || this.el.style.setProperty("--emoji-preview-height-full", "0px"), Object.keys(T).forEach((e) => {
      this.options[e] && this.el.style.setProperty(T[e], this.options[e].toString());
    });
  }
  updateStyleProperty(e, t) {
    this.el.style.setProperty(T[e], t.toString());
  }
  reinitialize() {
    this.renderSync();
  }
  onError(e) {
    const t = this.viewFactory.create(to, { message: this.i18n.get("error.load") }), i = this.el.offsetHeight || 375;
  ...
  showContent(e = this.emojiArea) {
    var t, i;
    e !== this.currentView && (this.currentView !== this.emojiArea && ((t = this.currentView) == null || t.destroy()), this.ui.pickerContent.classList.toggle(R.fullHeight, e !== this.emojiArea), w(this.ui.pickerContent, e.el), this.currentView = e, e === this.emojiArea ? (this.emojiArea.reset(), this.categoryTabs && this.ui.header.appendChild(this.categoryTabs.el)) : (i = this.categoryTabs) == null || i.el.remove());
  }
  hideVariantPopup() {
    var e;
...
function Vo(o) {
  ...
  const e = Lt(o), t = ((e == null ? void 0 : e.custom) || []).map((l) => ({
    ...
    custom: !0,
    tags: ["custom", ...l.tags || []]
  })), i = new At(), s = zo(e), r = new xo(e.i18n);
  s.then((l) => {
    i.emit("data:ready", l);
  }).catch((l) => {
    i.emit("error", l);
...
export {
  ...
  ce as Events,
  et as FocusTrap,
  Bo as InMemoryProvider,
  Ee as InMemoryStoreFactory,
  ze as IndexedDbStoreFactory,
  zt as LocalStorageProvider,
  Et as NativeRenderer,
  $e as RecentsProvider,
  kt as Renderer,
  Mo as SessionStorageProvider,
  I as animate,
  To as autoTheme,
  me as caseInsensitiveIncludes,
  Ne as computeHash,
  Do as createDatabase,
  Vo as createPicker,
  So as createStyleInjector,
  Ro as darkTheme,
  Oe as debounce,
  Io as deleteDatabase,
  V as empty,
  St as en,
  ...
  He as isSessionStorageAvailable,
  tt as lightTheme,
